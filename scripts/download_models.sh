...
wget -nc https://github.com/kenwaytis/faster-SadTalker-API/releases/download/0.1.3/alignment_WFLW_4HG.pth -O ./gfpgan/weights/alignment_WFLW_4HG.pth
wget -nc https://github.com/kenwaytis/faster-SadTalker-API/releases/download/0.1.3/detection_Resnet50_Final.pth -O ./gfpgan/weights/detection_Resnet50_Final.pth
...
wget -nc https://github.com/kenwaytis/faster-SadTalker-API/releases/download/0.1.3/parsing_parsenet.pth -O ./gfpgan/weights/parsing_parsenet.pth
